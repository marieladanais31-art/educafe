      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl space-y-4">
          ...
          <p className="text-base sm:text-lg text-slate-600 leading-relaxed">
            La Asociación Cristiana EducaFe aplica una estricta política de entorno seguro y prevención frente a cualquier forma de violencia o vulnerabilidad, en pleno cumplimiento de la <strong>Ley Orgánica 8/2021 (LOPIVI)</strong>.
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-6 rounded-3xl bg-white border border-slate-200/90 shadow-sm space-y-3">
            ...
            <p className="text-sm text-slate-600 leading-relaxed">
              Cumplimiento riguroso de la Ley Orgánica 8/2021, de 4 de junio, de protección integral a la infancia y la adolescencia frente a la violencia.
            </p>
          </div>
          ...
          <div className="p-6 rounded-3xl bg-white border border-slate-200/90 shadow-sm space-y-3">
            ...
            <p className="text-sm text-slate-600 leading-relaxed">
              La entidad cuenta con una profesional designada del ámbito del <strong>Trabajo Social</strong> como Delegada de Protección de la infancia.
            </p>
          </div>
        ...
        <div className="p-8 sm:p-12 rounded-3xl bg-slate-900 text-white border border-slate-800 space-y-6">
          ...
          <div className="pt-2 flex flex-col sm:flex-row items-start sm:items-center gap-4">
            ...
            <span className="text-xs text-slate-400">
              Atención directa y confidencial por profesional de Trabajo Social.
            </span>
          </div>
        </div>
      </section>
